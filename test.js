...
` && l();
  ...
  var rt = le((P) => {
    ...
    function yn(e, t, r, n) {
      if (((r = jt(r)), t === "href" || t === "src")) {
        ...
        if (
          ...
          Lt.test(r) ||
            ((Ct.lastIndex = 0),
            Ct.test(r) && ((ze.lastIndex = 0), ze.test(r))))
        )
          return "";
    ...
    function zt(e) {
      return e.replace(Cn, ":").replace(Tn, " ");
    }
    function It(e) {
  ...
  function C(e, t, r) {
    ...
    if (
      ...
      let i = function (l) {
        ...
        if (!l)
          try {
            t.walkTokens && C.walkTokens(o, t.walkTokens), (d = se.parse(o, t));
          } catch (u) {
            l = u;
          }
    ...
    try {
      let n = ie.lex(e, t);
      return t.walkTokens && C.walkTokens(n, t.walkTokens), se.parse(n, t);
    } catch (n) {
      if (
        ((n.message += `
Please report this to https://github.com/markedjs/marked.`),
  ...
  C.options = C.setOptions = function (e) {
    return ae(C.defaults, e), Wn(C.defaults), C;
  };
  C.getDefaults = or;
  C.defaults = ve;
  C.use = function (...e) {
    let t = ae({}, ...e),
      r = C.defaults.extensions || { renderers: {}, childTokens: {} },
      n;
    e.forEach((o) => {
      if (
        (o.extensions &&
        ...
        let i = C.defaults.renderer || new Ce();
      ...
      if (o.tokenizer) {
        let i = C.defaults.tokenizer || new Le();
      ...
      if (o.walkTokens) {
        let i = C.defaults.walkTokens;
        t.walkTokens = function (s) {
          o.walkTokens.call(this, s), i && i.call(this, s);
        };
      }
      n && (t.extensions = r), C.setOptions(t);
    });
  };
  C.walkTokens = function (e, t) {
    for (let r of e)
      switch ((t.call(C, r), r.type)) {
        case "table": {
          for (let n of r.header) C.walkTokens(n.tokens, t);
          for (let n of r.rows) for (let o of n) C.walkTokens(o.tokens, t);
          break;
        }
        case "list": {
          C.walkTokens(r.items, t);
          break;
        }
        default:
          ...
          C.defaults.extensions.childTokens[r.type]
            ? C.defaults.extensions.childTokens[r.type].forEach(function (n) {
                C.walkTokens(r[n], t);
              })
            : r.tokens && C.walkTokens(r.tokens, t);
      }
  };
  C.parseInline = function (e, t) {
    if (typeof e > "u" || e === null)
      throw new Error(
    ...
    (t = ae({}, C.defaults, t || {})), sr(t);
    try {
      let r = ie.lexInline(e, t);
      return (
        t.walkTokens && C.walkTokens(r, t.walkTokens), se.parseInline(r, t)
      );
    } catch (r) {
      if (
        ((r.message += `
Please report this to https://github.com/markedjs/marked.`),
  ...
  v.reg_board(
    ...
    ({ msto: e, $board: t }) => {
      t.html(
        `<h3 id="bb-rnklst-h2">犇犇排行榜 <span id="bb-rnklst-btn" class="bb-rnklst-span"> [<a>${
          e.show ? "收起" : "展开"
        }</a>]</span><span style="float: right;" class="bb-rnklst-span"> [<a id="refresh-bbrnk">刷新</a>]</span></h3><ol style="display: ${
          e.show ? "block" : "none"
        }" id="bb-rnklst"></ol>`
      );
  ...
  v.reg_hook_new(
    ...
    "@/.*",
    {
      ...
      copy_code_font: {
        ty: "string",
        dft: "'JetbrainsMono Nerd Font Mono', 'Jetbrains Mono', 'Fira Code', 'Fira Mono', Consolas",
...
如果选择“否”，您仍然可以在官网（exlg.cc）注册。`)
        ...
        return (
          N(
            xr
              .replaceAll("LG_USER_NAME", T.name)
              .replaceAll("LG_USER_COLOR", ct[T.color]),
            i,
            {
              onopen: (s) => {
                (y.boards = {}),
                ...
                let l = JSON.parse(I["sponsor-tag"].badges)[T.uid];
                typeof l > "u"
                  ? (y.isactive = !1)
                  : (t === null ? (Z = l) : (Z = t),
                  ...
                  T.uid in ue
                    ? ((y.pseudoInput.parentNode.style.display = ""),
                      (y.pseudoInput.value = Z.pseudo ??= ue[T.uid]))
                    : (y.pseudoInput.parentNode.style.display = "none");
                let d = (c = Z) => {
                  let a = {};
                  Object.assign(a, c),
                    (a.pseudo = T.badge ?? a.pseudo ?? ue[T.uid]);
                  let p = Fe(T.uid, ct[T.color], "luogu4", a, !1);
                ...
                (y.presetInput.oninput = () => {
                  ...
                  Object.keys(Te).forEach((c) => {
                    let a = document.createElement("div");
                    (a.innerHTML = Te[c].title),
                      (a.className = "exlg-regbadge-preset-title"),
                      y.badgePresetList.append(a),
                      Object.keys(Te[c].presetList).forEach((p, f) => {
                        let { name: x, config: h } = Te[c].presetList[p],
                          m = JSON.parse(h);
                        console.log(x, h, m);
              ...
              onconfirm: async (s) => {
                ...
                (s.title = "获取并验证令牌..."),
                  v.execute("token"),
                  console.log(Z);
                let l = { uid: T.uid, token: I["^token"].token, data: Z };
        ...
        let u = (c, a) => {
          c.children(".header").after(`<style>${dt}</style>`).after(`
                ...
                <div class="exlg-dropdown field">
                    <span data-v-3c4577b8="" class="key-small">CCF 评级: <strong>${T.ccfLevel}</strong> | 咕值排行: <strong>${T.ranking}</strong></span>
                </div>
                `),
            a.each(d);
      ...
      t.on("click", () => {
        t.prop("disabled", !0),
          ...
          ne({
            ...
            onload: (n) => {
              n.status === 200
                ? n.response === "success"
                  ...
                  : (M(
                      `Discuss unsuccessfully saved, return data: ${n.response}`
                    ),
                    t.text("保存失败"),
                    t
            ...
            onerror: (n) => {
              M(`Error:${n}`), t.removeAttr("disabled");
            },
          });
      }).css("margin-top", "5px");
      let r = g(
        `<a class="am-btn am-btn-warning am-btn-sm" name="save-discuss" href="https://lglg.top/show.php?url=${location.href}">查看备份</a>`
      ).css("margin-top", "5px");
        ...
        ({ gsto: t, args: r }) => {
          g(r).on("click", async () => {
            let { users: n } = await g.get(
                `/api/user/followings?user=${T.uid}`
              ),
              ...
              s.push(
                (async () =>
                  o.push(
                    ...(
                      await g.get(
                        `/api/user/followings?user=${T.uid}&page=${f}`
                      )
                    ).users.result
                  ))()
              );
        ...
        n = (m) => {
          ye(m) && (m = m.toUpperCase()),
            m === "" || typeof m > "u"
              ...
              : (location.href = `https://www.luogu.com.cn/problemnew/show/${m}`);
        },
 ...
 : 太大了。
*C register_badge
 : 加上了注册脚本。也可以在 exlg.cc 使用。
 : 写这个东西的人已经在崩溃的边缘了，球球各位不要催了。`;
  var Pr =
  ...
  v.reg_chore("update", "检查更新", "1D", ".*", null, async () => {
    ...
    t === "<<" &&
      N(
        `<p>检测到新版本 ${e}，点击确定将安装。</p>`,
        "检测到新版本",
        () =>
          (location.href =
            "https://exlg.oss-cn-shanghai.aliyuncs.com/latest/dist/extend-luogu.min.user.js")
      );
  });
          ...
          ({ gsto: d, args: u }) => {
            ...
            u.forEach((a) => {
              if (
                ...
                if (!d.problem_compare || E.user.uid === T.uid) return;
                o.then((x) => {
                  let h = 0,
                    m = f[1],
                    b = E.passedProblems;
